...
export class DataGrid {
    ...
    setLoader() {
        ...
        let width = table.width() > tableContainer.width() ? tableContainer.width() : table.width(),
            height = table.height() > tableContainer.height() ? tableContainer.height() : table.height();
    ...
    setFilter(column) {
        ...
        let columnSettings = _.find(this.options.columns, col => {
    ...
    static resizeColumn(customEvent) {
        ...
        //$(selector).height(event.rect.height);
