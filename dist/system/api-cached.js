...
System.register(['aurelia-framework', 'aurelia-http-client', 'underscore'], function (_export, _context) {
    "use strict";

    var Container, HttpClient, _, ApiCached;
    ...
    return {
        ...
        execute: function () {
            _export('ApiCached', ApiCached = function () {
