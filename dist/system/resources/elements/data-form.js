...
System.register(["aurelia-framework", "../../record"], function (_export, _context) {
    "use strict";

    var bindable, autoinject, bindingMode, Record, _createClass, _typeof, __decorate, __metadata, DataForm;
    ...
    return {
        ...
        execute: function () {
            ...
            _export("DataForm", DataForm = function () {
            ...
            _export("DataForm", DataForm = __decorate([autoinject, __metadata('design:paramtypes', [Element])], DataForm));
        }
    };
});